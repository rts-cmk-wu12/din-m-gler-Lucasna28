    ...
    <div className="relative bg-white shadow-lg -translate-x-6 -translate-y-6 z-0">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 py-4">
              <div className="flex items-center gap-2">
                <Image src="/house1.svg" alt="boliger solgt" width={16} height={16} className="bg-shape-shape02 p-4" /> 
                <div>
              ...
              <div className="flex items-center gap-2">
                <Image src="/home1.svg" alt="boliger til salg" width={16} height={16} className="bg-shape-shape02 p-4"/>
                <div>
      ...
      <ul className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
            <li className="space-y-2 flex">
                <Image src="/property1.svg" className="bg-shape-shape02 p-4 size-16 mr-4" alt="icon image for property text" width={16} height={16}/>
            ...
            <li className="space-y-2 flex">
                <Image src="/maps-and-flags1.svg" className="bg-shape-shape02 p-4 size-16 mr-4" alt="icon image for maps and flags text" width={16} height={16}/>
                <div className="flex flex-col w-48 h-full"> 
            ...
            <li className="space-y-2 flex">
                <Image src="/customer1.svg" width={16} height={16} className="bg-shape-shape02 p-4 size-16 mr-4" alt="icon image for customer text" /> 
                <div className="flex flex-col w-48 h-full">
